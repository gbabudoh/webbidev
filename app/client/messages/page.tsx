...
function PanelSkeleton() {
  return (
    <div className="flex h-[700px] bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden animate-pulse">
    ...
    <div className="space-y-8 pb-12">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 font-medium">
              {viewMode === 'project'
                ...
                : 'Send direct messages to other users on the platform.'}
            </p>
          </div>
      ...
      {!loading && viewMode === 'project' && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="flex flex-col lg:flex-row bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden lg:h-[700px]"
        >
          {/* Left sidebar */}
          <div className="lg:w-72 shrink-0 border-b lg:border-b-0 lg:border-r border-slate-100 flex flex-col max-h-64 lg:max-h-none">
            <div className="px-5 py-4 border-b border-slate-100 shrink-0">
              <p className="text-base font-black text-slate-900 tracking-tight">Conversations</p>
          ...
          <div className="flex-1 flex flex-col min-w-0 min-h-[400px] lg:min-h-0">
            {selectedConversationId ? (
              ...
              <div className="flex flex-col items-center justify-center flex-1 gap-3 text-center p-8">
                ...
                <p className="text-base font-black text-slate-900">Select a conversation</p>
          ...
          <div className="lg:w-72 shrink-0 border-b lg:border-b-0 lg:border-r border-slate-100 flex flex-col max-h-64 lg:max-h-none">
            <div className="px-5 py-4 border-b border-slate-100 shrink-0">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <p className="text-base font-black text-slate-900 tracking-tight">Direct Messages</p>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 text-white text-sm font-bold hover:bg-slate-800 transition-colors"
              >
            ...
            <div className="flex-1 overflow-y-auto">
              {directConversations.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 px-6 text-center">
                  ...
                  <p className="text-sm font-black text-slate-900 mb-1">No conversations yet</p>
            ...
            {showComposer ? (
              <div className="flex flex-col h-full">
                <div className="px-6 py-5 border-b border-slate-100 shrink-0 flex items-center justify-between">
                  <div>
                    <p className="text-base font-black text-slate-900">New Message</p>
                    <p className="text-xs text-slate-400 font-medium">Compose a direct message</p>
                  </div>
                  <button
                    onClick={() => setShowComposer(false)}
                    className="text-sm font-bold text-slate-500 hover:text-slate-900 transition-colors px-4 py-2 rounded-xl hover:bg-slate-100"
                  >
                    Cancel
                  </button>
                </div>
              ...
              <div className="flex flex-col items-center justify-center flex-1 gap-3 text-center p-8">
                ...
                <p className="text-base font-black text-slate-900">No conversation selected</p>
                <p className="text-sm text-slate-400 font-medium max-w-xs">
                  Select a conversation from the list or compose a new message.
                </p>
                <button
                  onClick={() => setShowComposer(true)}
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-900 text-white text-sm font-bold hover:bg-slate-800 transition-colors mt-2"
                >
